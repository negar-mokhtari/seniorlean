...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'status'                => 'وضعیت',
        'price'                 => 'قیمت',
        'money_status'          => 'وضعیت هزینه',
        'money'                 => 'پولی',
        'type_content'          => 'نوع محتوا',
        'video'                 => 'ویدیو',
        'voice'                 => 'فایل صوتی',
        'description'           => 'توضیحات',
        'video'                 => 'فیلم',
        'question_type'         => 'نوع سوال',
        'question_blank'        => 'صورت سوال جای خالی',
        'blank_mode_answers'    => 'جواب های جاهای خالی به ترتیب',
        'sentence_missedup_answer'=> 'جمله مرتب',
        'wrong_text_question'    => 'صورت سوال جمله یا پاراگراف اشتباه',
        'multiple_choice_question' => 'صورت سوال چند گزینه ای',
        'option1'                => 'اولین گزینه',
        'question'              =>  'صورت سوال'
