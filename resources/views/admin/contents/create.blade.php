...
@section('content')
    ...
    <div class="kt-portlet">
        <div class="kt-portlet__head">
            ...
            <div class="kt-portlet__head-toolbar">
                <a href="{{route('admin.contents.index',['category_id' => request('category_id')])}}" class="btn btn-label-brand ">
                    <i class="la la-arrow-right"></i>
                    <span class="kt-hidden-mobile"> بازگشت به محتوا ها</span>
                </a>
            </div>
        </div>
        @if($errors->any())
    ...
    @endif
    <!--begin::Form-->
        <form method="POST" action="{{route('admin.contents.store',['category_id' => request('category_id')])}}" class="kt-form" enctype="multipart/form-data">
            @csrf
            <div class="kt-portlet__body">
                ...
                <div class="form-group row">
                    <div class="col-lg-1"></div>
                    <label class="col-form-label col-lg-3 col-sm-12">آپلود تصویر محتوا </label>
                ...
                <div class="form-group row">
                    <div class="col-lg-1"></div>
                    <label class="col-form-label col-lg-3 col-sm-12">آپلود فیلم محتوا </label>
                    <div class=" col-lg-4 col-md-9 col-sm-12">
                        <div class="custom-file">
