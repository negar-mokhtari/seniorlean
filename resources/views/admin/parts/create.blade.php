...
@section('content')
    ...
    <div class="kt-portlet">
        <div class="kt-portlet__head">
            ...
            <div class="kt-portlet__head-toolbar">
                <a href="{{route('admin.parts.index',['course_id' => request('course_id')])}}" class="btn btn-label-brand ">
                    <i class="la la-arrow-right"></i>
                    <span class="kt-hidden-mobile"> بازگشت به بخش های دوره</span>
                </a>
            </div>
        </div>
        @if($errors->any())
    ...
    @endif
    <!--begin::Form-->
        <form method="POST" action="{{route('admin.parts.store',['course_id' => request('course_id')])}}" class="kt-form">
            @csrf
